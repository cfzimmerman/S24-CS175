...
// asstcommon.h, so remove them from your asst4.cpp.
// =================================================================
...
static const int PICKING_SHADER =
    2; // index of the picking shader is g_shaerFiles
...
static shared_ptr<SgRbtNode> g_skyNode, g_groundNode, g_robot1Node,
    g_robot2Node;
static shared_ptr<SgRbtNode>
    g_currentPickedRbtNode; // used later when you do picking
*/
...
static void drawStuff(const ShaderState &curSS, bool picking) // { ...
  ...
  g_currentPickedRbtNode =
      picker.getRbtNodeAtXY(g_mouseClickX * g_wScale, g_mouseClickY * g_hScale);
